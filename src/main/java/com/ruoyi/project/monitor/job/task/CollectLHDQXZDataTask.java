...
@Component
@Lazy(false)
public class CollectLHDQXZDataTask {
//    @Autowired
...
//    private DeviceChannelHisDataService deviceChannelHisDataService;
    ...
    static {
        CollectLHDQXZDataTask.logger = LoggerFactory.getLogger(CollectLHDQXZDataTask.class);
        CollectLHDQXZDataTask.executor = Executors.newFixedThreadPool(20);
    }
...
//                deviceChannel.setValue(valueStr);
    ...
    private int addData(String identifier, GmHistorydata gmHistorydata, GmLatestdata gmLatestdata) {
        if (identifier.equals("SunRadiation")) {
            gmHistorydata.setChId("3aa0912575ac05a70175cfc022121601");
            gmLatestdata.setChId("3aa0912575ac05a70175cfc022121601");
        } else if (identifier.equals("Rainfall")) {
            gmHistorydata.setChId("3aa0912575ac05a70175cfc022121602");
            gmLatestdata.setChId("3aa0912575ac05a70175cfc022121602");
        } else if (identifier.equals("Atmosphere")) {
            gmHistorydata.setChId("3aa0912575ac05a70175cfc022121603");
            gmLatestdata.setChId("3aa0912575ac05a70175cfc022121603");
        } else if (identifier.equals("WindDirection")) {
            gmHistorydata.setChId("3aa0912575ac05a70175cfc022121604");
            gmLatestdata.setChId("3aa0912575ac05a70175cfc022121604");
        } else if (identifier.equals("WindSpeed")) {
            gmHistorydata.setChId("3aa0912575ac05a70175cfc022121605");
            gmLatestdata.setChId("3aa0912575ac05a70175cfc022121605");
        } else if (identifier.equals("Humidity")) {
            gmHistorydata.setChId("3aa0912575ac05a70175cfc022121606");
            gmLatestdata.setChId("3aa0912575ac05a70175cfc022121606");
        }else if (identifier.equals("temperature")) {
            gmHistorydata.setChId("3aa0912575ac05a70175cfc022121607");
            gmLatestdata.setChId("3aa0912575ac05a70175cfc022121607");
        }
