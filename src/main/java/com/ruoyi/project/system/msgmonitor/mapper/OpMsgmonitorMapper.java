package com.ruoyi.project.system.msgmonitor.mapper;
 ...
 * @date 2020-12-07
 */
public interface OpMsgmonitorMapper 
{
    /**
     * 查询短信监控配置信息
     * 
     ...
     * 批量删除短信监控配置信息
     * 
     * @param mesIds 需要删除的数据ID
     * @return 结果
     */
    public int deleteOpMsgmonitorByIds(String[] mesIds);
}
